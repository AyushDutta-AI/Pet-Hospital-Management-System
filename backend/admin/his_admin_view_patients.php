                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">View Pets</li>
                                        </ol>
                                    </div>
                                            ...
                                            <div class="col-12 text-sm-center form-inline" >
                                                <div class="form-group mr-2" style="display:none">
                                                    <select id="demo-foo-filter-status" class="custom-select custom-select-sm">
                                                        ...
                                                        <option value="OutPets">OutPets</option>
                                                        <option value="InPets">InPets</option>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Admit Code</th>
                                                <th data-hide="phone">Address of Owner</th>
                                                <th data-hide="phone">Type of Pet</th>
