                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> Veterinarians </a></li>
                                            <li class="breadcrumb-item active">Add Veterinarians </li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Add  Veterinarians  Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label"> Veterinarian Number</label>
                                            ...
                                            <button type="submit" name="add_doc" class="ladda-button btn btn-success" data-style="expand-right">Add Veterinarians </button>
