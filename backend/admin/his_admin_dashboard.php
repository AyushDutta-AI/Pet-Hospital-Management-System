                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Pet Hospital Management System Dashboard</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM his_patients WHERE pat_type = 'OutPet' ";
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Out Pets</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM his_patients WHERE pat_type = 'InPet' ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                ...
                                                <p class="text-muted mb-1 text-truncate">In Pets</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
